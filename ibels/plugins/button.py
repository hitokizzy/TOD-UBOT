...
# button post makker for ibel-ubot thanks to uniborg for the base

# by @hitokizzy (@mrconfused)
import os
import re
...
from . import edit_delete, reply_id, ibel
...
@ibel.sad_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [ibel-ubot]<buttonurl:https://t.me/ibel-ubot17:same> [support]<buttonurl:https://t.me/ibel-ubot_support>",
    },
)
async def _(event):
...
@ibel.sad_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test [google]<buttonurl:https://www.google.com> [ibel-ubot]<buttonurl:https://t.me/ibel-ubot17:same> [support]<buttonurl:https://t.me/ibel-ubot_support>",
    },
)
async def _(event):
