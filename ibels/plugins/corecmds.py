...
from . import CMD_HELP, CMD_LIST, SUDO_LIST, edit_delete, edit_or_reply, reply_id, ibel
...
@ibel.sad_cmd(
    ...
    info={
        ...
        "description": "Reply to any external plugin(supported by ibel) to install it in your bot.",
        "usage": "{tr}install",
    },
)
