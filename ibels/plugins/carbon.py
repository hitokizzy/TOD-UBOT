...
from . import deEmojify, edit_or_reply, ibel
...
async def carbon_api(event):
    ...
    ibel = await edit_or_reply(event, "`Carbonizing...\n25%`")
    ...
    await ibel.edit("`Processing..\n75%`")

    await asyncio.sleep(2)
    await ibel.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await ibel.edit("`Uploading..`")
...
async def carbon_api(event):
    """A Wrapper for carbon.now.sh"""
    ibel = await edit_or_reply(event, "🔲🔲🔲🔲🔲")
    ...
    await ibel.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await ibel.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
        force_document=True,
...
async def carbon_api(event):
    ...
    await ibel.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await ibel.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await ibel.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await ibel.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await ibel.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await ibel.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await ibel.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await ibel.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
