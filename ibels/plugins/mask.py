...
async def sadbot(sadmemes):
    ...
    ibel = await awooify(ibel)
    await sadevent.delete()
    await sadmemes.client.send_file(sadmemes.chat_id, ibel, reply_to=replied)
