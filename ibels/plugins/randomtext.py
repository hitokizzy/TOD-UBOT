...
async def _(event):
    ...
    if x == 13:
        await event.edit(
            "[A perfect justifisadion for breaking a promise...](https://telegra.ph/file/0b8fb8fb729d157844ac9.jpg)",
            link_preview=True,
        )
    if x == 14:
        await event.edit(
    ...
    if x == 27:
        await event.edit(
            "[A justifisadion for not voting!](https://telegra.ph/file/87d475a8f9a8350d2450e.jpg)",
            link_preview=True,
        )
    if x == 28:
        await event.edit(
...
async def _(event):  # sourcery no-metrics
    ...
    if x == 16:
        await event.edit(
            '`"200 years ago, people would never have guessed that humans in the future would communisade by silently tapping on glass."`'
        )
    if x == 17:
        await event.edit(
    ...
    if x == 33:
        await event.edit(
            '`"Humans are designed to learn through experience yet the edusadion system has made it so we get no experience."`'
        )
    if x == 34:
        await event.edit(
    ...
    if x == 88:
        await event.edit(
            '`"Doing something alone is kind of ibel, but doing it solo is cool af."`'
        )
    if x == 89:
        await event.edit(
...
async def _(event):  # sourcery no-metrics
    ...
    if x == 18:
        await event.edit(
            r"`\"When researching things to do for your next leisure travel. Include \<location\> tourism scam into your search. All tourist heavy areas will have their own scams. This should not dampen your excitement but heighten your knowledge so your vasadion will be more enjoyable.\"`"
        )
    if x == 19:
        await event.edit(
    ...
    if x == 25:
        await event.edit(
            "`\"If you're a student planning on your career, look up postings of your dream job, find the skills and qualifisadions you'll need, then work backwards from there.\"`"
        )
    if x == 26:
        await event.edit(
    ...
    if x == 55:
        await event.edit(
            '`"Buy a small bottle of perfume you have never tried on before going for a vasadion and use it for while you\'re there. At any point after your vasadion, you get a sniff of it, it brings back those memories instantly. Because scents are among the most powerful memory triggers."`'
        )
    if x == 56:
        await event.edit(
    ...
    if x == 80:
        await event.edit(
            '`"When filling out applisadions online, make sure you copy responses which typically take a long time to write, and paste them to a text file. You never know when you could get a server timeout."`'
        )
    if x == 81:
        await event.edit(
...
async def _(event):  # sourcery no-metrics
    ...
    if x == 28:
        await event.edit(
            '`"What are some good and bad things about the edusadion system in your country?"`'
        )
    if x == 29:
        await event.edit('`"What do you think of online edusadion?"`')
    if x == 30:
    ...
    if x == 55:
        await event.edit(
            '`"What is the most important change that should be made to your country’s edusadion system?"`'
        )
    if x == 56:
