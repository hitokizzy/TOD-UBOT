...
@ibel.sad_cmd(
    ...
    info={
        ...
        "examples": "{tr}admins @ibel-ubot_support",
    },
)
async def _(event):
...
@ibel.sad_cmd(
    ...
    info={
        ...
        "examples": "{tr}bots @ibel-ubot_support",
    },
)
async def _(event):
    "To get list of bots."
...
async def get_users(show):
    ...
    sadevent = await edit_or_reply(show, "`getting users list wait...`  ")
    try:
        ...
        mentions += " " + str(e) + "\n"
    await edit_or_reply(sadevent, mentions)
...
@ibel.sad_cmd(
    ...
    info={
        ...
        "examples": "{tr}chatinfo @ibel-ubot_support",
    },
)
async def info(event):
    "To get group information"
    sadevent = await edit_or_reply(event, "`Analysing the chat...`")
    chat = await get_chatinfo(event, sadevent)
    if chat is None:
        return
    caption = await fetch_info(chat, event)
    try:
        await sadevent.edit(caption, parse_mode="html")
    except Exception as e:
        if BOTLOG:
        ...
        await sadevent.edit("`An unexpected error has occurred.`")


async def get_chatinfo(event, sadevent):
    ...
    try:
        ...
        try:
            ...
            await sadevent.edit("`Invalid channel/group`")
            return None
            ...
            await sadevent.edit("`Channel or supergroup doesn't exist`")
            return None
        except (TypeError, ValueError) as err:
            LOGS.info(err)
            await edit_delete(sadevent, "**Error:**\n__Can't fetch the chat__")
            return None
    return chat_info
