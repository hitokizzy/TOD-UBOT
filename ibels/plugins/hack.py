...
@ibel.sad_cmd(
    pattern="selfie$",
    command=("selfie", plugin_category),
    info={
        "header": "selfie.",
        "description": "selfie",
        "note": "This is just for fun. Not real hacking.",
...
async def _(event):
    event = await edit_or_reply(event, "selfie")
    await event.edit("Target Selected...")
    await asyncio.sleep(0.5)
    await event.edit("Generating String.")
    await asyncio.sleep(0.5)
    await event.edit("Generating String..")
    await asyncio.sleep(0.5)
    await event.edit("Generating String...")
    await asyncio.sleep(0.5)
    await event.edit("Taking picture from front camera.")
    await asyncio.sleep(0.5)
    await event.edit("Taking picture from front camera..")
    ...
    await asyncio.sleep(1)
    await event.edit(
        "[Photo Uploaded](https://telegra.ph/file/67a0ea8363a0c41445b43.jpg)",
        link_preview=True,
    )
