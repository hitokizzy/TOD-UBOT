...
@ibel.sad_cmd(
    ...
    info={
        ...
        "examples": "{tr}downside ibel-ubot",
    },
)
...
@ibel.sad_cmd(
    ...
    info={
        ...
        "examples": "{tr}subscript ibel-ubot",
    },
)
async def stylish_generator(event):
...
@ibel.sad_cmd(
    ...
    info={
        ...
        "examples": "{tr}superscript ibel-ubot",
    },
)
async def stylish_generator(event):
