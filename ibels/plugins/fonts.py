...
@ibel.sad_cmd(
    ...
    info={
        ...
        "examples": "{tr}fmusical ibel-ubot",
    },
)
...
@ibel.sad_cmd(
    ...
    info={
        ...
        "examples": "{tr}smallcaps ibel-ubot",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
...
@ibel.sad_cmd(
    ...
    info={
        ...
        "examples": "{tr}smothtext ibel-ubot",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
