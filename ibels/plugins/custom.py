...
@ibel.sad_cmd(
    ...
    info={
        ...
        "var name": "**[list of vars]**(https://ibel-ubot.gitbook.io/ibel-ubot/data-vars-setup)",
        "usage": [
...
@ibel.sad_cmd(
    ...
    info={
        "header": "To customize your ibel-ubot.",
        "options": {
...
@ibel.sad_cmd(
    ...
    info={
        "header": "To delete costomization of your ibel-ubot.",
        "options": {
