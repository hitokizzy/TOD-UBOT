...
PING_PIC = (
    os.environ.get("PING_PIC") or "https://telegra.ph/file/486715ddbbb29da89b2ed.png"
)
...
async def _(event):
    ...
    start = datetime.now()
    ibel = await edit_or_reply(
        event,
        "<b><i>“SAD USERBOT, NO DRAMA INSIDE...” !! </b></i>",
        "html",
    )
    end = datetime.now()
