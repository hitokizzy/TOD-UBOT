...
async def morning(morning):
    ...
    txt = random.choice(sadmemes.GDMORNING)
...
async def noon(noon):
    ...
    txt = random.choice(sadmemes.GDNOON)
...
async def night(night):
    ...
    txt = random.choice(sadmemes.GDNIGHT)
...
async def hi(event):
    ...
    await edit_or_reply(
        event,
        f"{ibel}✨✨{ibel}✨{ibel}{ibel}{ibel}\n{ibel}✨✨{ibel}✨✨{ibel}✨\n{ibel}{ibel}{ibel}{ibel}✨✨{ibel}✨\n{ibel}✨✨{ibel}✨✨{ibel}✨\n{ibel}✨✨{ibel}✨{ibel}{ibel}{ibel}\n☁☁☁☁☁☁☁☁",
    )
