...
class ibelubotClient(TelegramClient):
    def sad_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**ibel-ubot Error report**\n\n"
                        link = "[here](https://t.me/ibel-ubot_support)"
            ...
            if pattern is not None:
                ...
                if edited:
                    ibel.add_event_handler(func, events.MessageEdited(**kwargs))
                ibel.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                ibel.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                ibel.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
ibelubotClient.fast_download_file = download_file
ibelubotClient.fast_upload_file = upload_file
ibelubotClient.reload = restart_script
ibelubotClient.get_msg_link = get_message_link
ibelubotClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    ibelubotClient.send_message = send_message
    ibelubotClient.send_file = send_file
    ibelubotClient.edit_message = edit_message
