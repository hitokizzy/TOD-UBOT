...
TODLOGO = "https://telegra.ph/file/902492291f182109319ee.png"
...
async def inline_handler(event):  # sourcery no-metrics
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**Ibel's Ubot"):
            ...
            ALIVE_PIC = gvarstatus("ALIVE_PIC") or ("https://telegra.ph/file/902492291f182109319ee.png")
            IALIVE_PIC = gvarstatus("IALIVE_PIC") or ("https://telegra.ph/file/902492291f182109319ee.png")
            if IALIVE_PIC:
            ...
            PM_PIC = gvarstatus("pmpermit_pic") or ("https://telegra.ph/file/902492291f182109319ee.png")
            if PM_PIC:
...
@tod.tgbot.on(CallbackQuery(data=re.compile(b"close")))
@check_owner
...
@tod.tgbot.on(CallbackQuery(data=re.compile(b"check")))
...
@tod.tgbot.on(CallbackQuery(data=re.compile(b"(.*)_menu")))
@check_owner
async def on_plug_in_callback_query_handler(event):
...
@tod.tgbot.on(CallbackQuery(data=re.compile(rb"mainmenu")))
@check_owner
async def on_plug_in_callback_query_handler(event):
    _result = main_menu()
