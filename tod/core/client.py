...
class todubotClient(TelegramClient):
    def tod_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**TODUBOT Error report**\n\n"
                        link = "[here](https://t.me/tod-ubot_support)"
            ...
            if pattern is not None:
                ...
                if edited:
                    tod.add_event_handler(func, events.MessageEdited(**kwargs))
                tod.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                tod.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                tod.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
todubotClient.fast_download_file = download_file
todubotClient.fast_upload_file = upload_file
todubotClient.reload = restart_script
todubotClient.get_msg_link = get_message_link
todubotClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    todubotClient.send_message = send_message
    todubotClient.send_file = send_file
    todubotClient.edit_message = edit_message
