...
from wand.image import Image as sadimage

from .utils import _sadutils
...
async def sad_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def sad_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = sadimage(filename=picture_name)
    main_image.resize(
