...
@tod.tod_cmd(
    ...
    info={
        ...
        "var name": "**[list of vars]**(https://TODUBOT.gitbook.io/TODUBOT/data-vars-setup)",
        "usage": [
    ...
    if vname in vlist:
        ...
        if cmd == "set":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"Check @sad_alive")
            if not vinfo:
                return await edit_delete(
...
@tod.tod_cmd(
    ...
    info={
        "header": "To customize your TODUBOT.",
        "options": {
...
async def custom_todubot(event):
    "To customize your TODUBOT."
    reply = await event.get_reply_message()
    text = None
    if reply:
        text = reply.text
...
@tod.tod_cmd(
    ...
    info={
        "header": "To delete costomization of your TODUBOT.",
        "options": {
...
async def custom_todubot(event):
    "To delete costomization of your TODUBOT."
    input_str = event.pattern_match.group(1)
    if input_str == "pmpermit":
