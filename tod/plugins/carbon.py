...
from . import deEmojify, edit_or_reply, tod
...
async def carbon_api(event):
    ...
    tod = await edit_or_reply(event, "`Carbonizing...\n25%`")
    ...
    await tod.edit("`Processing..\n75%`")

    await asyncio.sleep(2)
    await tod.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await tod.edit("`Uploading..`")
...
async def carbon_api(event):
    """A Wrapper for carbon.now.sh"""
    tod = await edit_or_reply(event, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await event.get_reply_message()
    pcode = event.text
    if pcode[5:]:
...
async def carbon_api(event):
    ...
    await tod.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await tod.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
        force_document=True,
...
async def carbon_api(event):
    ...
    await tod.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await tod.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await tod.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await tod.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await tod.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await tod.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await tod.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await tod.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
