...
from . import CMD_HELP, CMD_LIST, SUDO_LIST, edit_delete, edit_or_reply, reply_id, tod
...
@tod.tod_cmd(
    ...
    info={
        ...
        "description": "Reply to any external plugin(supported by tod) to install it in your bot.",
        "usage": "{tr}install",
    },
)
...
async def send(event):
    ...
    the_plugin_file = f"./tods/plugins/{input_str}.py"
