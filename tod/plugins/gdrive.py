...
from tod import tod
from tod.core.logger import logging
...
# TODUBOT Google Drive managers  ported from Projectbish and added extra things by @mrconfused
...
async def upload(gdrive, service, file_path, file_name, mimeType, dir_id=None):
    ...
    body = {
        "name": file_name,
        "description": "Uploaded from Telegram using TODUBOT.",
        "mimeType": mimeType,
