...
# button post makker for TODUBOT thanks to uniborg for the base
...
from . import edit_delete, reply_id, tod
...
@tod.tod_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [TODUBOT]<buttonurl:https://t.me/tod-ubot17:same> [support]<buttonurl:https://t.me/tod-ubot_support>",
    },
)
async def _(event):
...
@tod.tod_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test [google]<buttonurl:https://www.google.com> [TODUBOT]<buttonurl:https://t.me/tod-ubot17:same> [support]<buttonurl:https://t.me/tod-ubot_support>",
    },
)
async def _(event):
